...
.data
	...
	buffer2		BYTE	"請輸入 Random Number 的數量(少於50): ", 0
	buffer3		BYTE	"請輸入 Random Number 的 Lowerbound: ", 0
	buffer4		BYTE	"請輸入 Random Number 的 Upperbound: ", 0
	buffer5		BYTE	"請選擇 (1) Selection Sort (2) Insertion Sort (3) Quick Sort (4) Exit", 0
