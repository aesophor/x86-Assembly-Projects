...
.data
	buffer1		BYTE "我是 U10516045 王冠中", 0
	buffer2		BYTE "請輸入選擇 (1) Hamming code Generation (2) Hamming Code Verification (3) Exit", 0
	buffer3		BYTE "Invalid Input, please retry.", 0
	buffer4		BYTE "請在下一行輸入欲編碼的binary data string (2-前57位元)", 0
	buffer5		BYTE "錯誤的位元在位置", 0
	buffer6		BYTE "請在下一行輸入欲處理的Hamming code binary string (5-前63位元)", 0
	buffer7		BYTE "正確", 0
